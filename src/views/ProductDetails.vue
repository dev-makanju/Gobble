            ...
            <div v-if="!loading" class="item" style="display:flex;flex-direction:column;margin-left: 4px; ">
               <div class="review">
                  <div class="stars">
                     ...
                     <p @click="getProReview($route.params.slug)" class="show">show more...</p>
                  </div> 
               </div>
               <!---reviews-->
               <div class="review">
                  <div v-for="review in reviewCart" :key="review.id" class="review-container">
...
export default {
   ...
   methods:{
      ...
      ...mapActions('cart' , ['addProduct' , 'getProductReview']),
      getProduct(){
         this.loading = true;
